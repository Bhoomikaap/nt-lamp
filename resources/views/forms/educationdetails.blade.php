    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="ed-tenth">
            ...
            <div class="col-xs-12">
                <div class="row pad-t10">
                    <div class="form-group">
                        <label for="10_course">Course</label>
        ...
        <div role="tabpanel" class="tab-pane" id="ed-twelth">
            ...
            <div class="col-xs-12">
                <div class="row pad-t10">
                    <div class="form-group">
                        <label for="12_course">Course</label>
        ...
        <div role="tabpanel" class="tab-pane" id="ed-ug">
            ...
            <div class="col-xs-12">
                <div class="row pad-t10">
                    <div class="form-group">
                       <label for="ug_course">Course</label>
        ...
        <div role="tabpanel" class="tab-pane" id="ed-pg">
            ...
            <div class="col-xs-12">
                <div class="row pad-t10">
                    <div class="form-group">
                        <label for="pg_course">Course</label>
        ...
        <div role="tabpanel" class="tab-pane" id="ed-other">
            ...
            <div class="col-xs-12">
                <div class="row pad-t10">
                    <div class="form-group">
                        <label for="other_course">Course</label>
