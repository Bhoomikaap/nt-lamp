        ...
        <div class="col-sm-6 pad-t20">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            {!! Form::number('country_code', null, ['class'=>'form-control','placeholder'=>'Country Code']) !!}
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            {!! Form::number('contact_no', null, ['class'=>'form-control','placeholder'=>'Contact number']) !!}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row hmar5">
                    ...
                    <div class="col-xs-6 hpad5">
                        ...
                        <input
                                ...
                                class="form-control fresher"
                                placeholder="End Year" id="experience_end_date" />
                    </div>
                </div>
                <div class="row hmar5">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="">Upload Resume Document</label> <input
                                type="file" name="resume" class="form-control">
