                    ...
                    <div class="container">
                        ...
                        <nav class="collapse navbar-collapse bs-navbar-collapse">
                            <ul class="nav navbar-nav navbar-right mar-sm-t25">
                                <li @if(route('SearchJobs') == Request::url()
                                    or (route('SearchJobs',['united-arab-emirates']) == Request::url())
                                    or (route('SearchJobs',['saudi-arabia']) == Request::url())
                                    or (route('SearchJobs',['qatar']) == Request::url())
                                    or (route('SearchJobs',['oman']) == Request::url())
                                    or (route('SearchJobs',['kuwait']) == Request::url())
                                    or (route('SearchJobs',['bahrain']) == Request::url())
                                    or (route('SearchJobs',['all-gulf-countries']) == Request::url())) class="active" @endif>
                                    <a href="{{URL::route('SearchJobs')}}">Search Jobs by Country</a>
                                </li>

                                <li class="dropdown @if((route('SearchJobs',['united-arab-emirates']) == Request::url())
                                    or (route('SearchJobs',['saudi-arabia']) == Request::url())
                                    or (route('SearchJobs',['qatar']) == Request::url())
                                    or (route('SearchJobs',['oman']) == Request::url())
                                    or (route('SearchJobs',['kuwait']) == Request::url())
                                    or (route('SearchJobs',['bahrain']) == Request::url())
                                    or (route('SearchJobs',['all-gulf-countries']) == Request::url())) active @endif">
                                @if((route('SearchJobs',['united-arab-emirates']) == Request::url())
                                    or (route('SearchJobs',['saudi-arabia']) == Request::url())
                                    or (route('SearchJobs',['qatar']) == Request::url())
                                    or (route('SearchJobs',['oman']) == Request::url())
                                    or (route('SearchJobs',['kuwait']) == Request::url())
                                    or (route('SearchJobs',['bahrain']) == Request::url())
                                    or (route('SearchJobs',['all-gulf-countries']) == Request::url()))
                                ...
                                @endif
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{URL::route('SearchJobs',['united-arab-emirates'])}}"
                                               @if(route('SearchJobs',['united-arab-emirates']) == Request::url()) class="active" @endif>
                                                UAE
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::route('SearchJobs',['saudi-arabia'])}}"
                                               @if(route('SearchJobs',['saudi-arabia']) == Request::url()) class="active" @endif>
                                                Saudi Arabia</a>
                                        </li>
                                        <li>
                                            <a href="{{URL::route('SearchJobs',['oman'])}}"
                                               @if(route('SearchJobs',['oman']) == Request::url()) class="active" @endif>
                                                Oman
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::route('SearchJobs',['qatar'])}}"
                                               @if(route('SearchJobs',['qatar']) == Request::url()) class="active" @endif>
                                                Qatar
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::route('SearchJobs',['kuwait'])}}"
                                               @if(route('SearchJobs',['kuwait']) == Request::url()) class="active" @endif>
                                                Kuwait
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::route('SearchJobs',['bahrain'])}}"
                                               @if(route('SearchJobs',['bahrain']) == Request::url()) class="active" @endif>
                                                Bahrain
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::route('SearchJobs',['all-gulf-countries'])}}"
                                               @if(route('SearchJobs',['all-gulf-countries']) == Request::url()) class="active" @endif>
                                                All Gulf Countries
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <li>
                                        <a id="drop4"
                                           ...
                                           aria-expanded="false">
                                            ...
                                            @if(isset(Auth::user()->userdetail->profile_image)
                                                and Auth::user()->userdetail->profile_image != '')
                                                <img src="{{url('uploads/profile/'.Auth::user()->userdetail->profile_image)}}"
                                                     class="circle"
                                                     height="45px"
                                                     width="45px" />
                                            @endif
                    ...
                    $("#login_form").validate({
                        ...
                        messages:{
                            email:{
                                ...
                                email:"<span class='glyphicon glyphicon-ban-circle'></span>"
                            },
                            password:{
                                required:"<span class='glyphicon glyphicon-exclamation-sign'></span>"
                            }
